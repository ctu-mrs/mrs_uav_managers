...
colcon test --packages-select mrs_uav_managers --ctest-args -R 'validate_reference_array_service' --event-handlers console_direct+ console_stderr- console_start_end-
