...
colcon test --packages-select mrs_uav_managers --ctest-args -R 'midair_service_fail_cause_enabling_output_failed' --event-handlers console_direct+ console_stderr- console_start_end-
