...
colcon test --packages-select mrs_uav_managers --ctest-args -R 'takeoff_service_fail_cause_tracker' --event-handlers console_direct+ console_stderr- console_start_end-
