...
colcon test --packages-select mrs_uav_managers --ctest-args -R 'set_gains_should_fail_service' --event-handlers console_direct+ console_stderr- console_start_end-
