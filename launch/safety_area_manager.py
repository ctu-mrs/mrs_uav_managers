...
def generate_launch_description():
    ...
    platform_config = IfElseSubstitution(
        condition=PythonExpression(['"', platform_config, '" != "" and ',
                                   'not "', platform_config, '".startswith("/")']),
    ...
    world_config = IfElseSubstitution(
        condition=PythonExpression(['"', world_config, '" != "" and ',
                                   'not "', world_config, '".startswith("/")']),
    ...
    network_config = IfElseSubstitution(
        condition=PythonExpression(['"', network_config, '" != "" and ',
                                   'not "', network_config, '".startswith("/")']),
    ...
    # #{ safety area manager node

    safety_area_manager_node = ComposableNode(

        package=pkg_name,
        plugin='mrs_uav_managers::safety_area_manager::SafetyAreaManager',
        namespace=uav_name,
        name='safety_area_manager',
        ...
        remappings=[
            ...
            # services
            # TODO remap these properly once the service names are implemented
            # ("~/get_safety_zone_at_height_in", "~/get_safety_zone_at_height"),
            ...
            # ("~/save_world_config_in", "~/save_world_config"),
            # ("~/load_world_config_in", "~/load_world_config"),
            # ("~/set_safety_border_in", "~/set_safety_border"),
            # ("~/set_safety_area_in", "~/set_safety_area"),
            # ("~/set_world_config_in", "~/set_world_config"),
            # ("~/get_world_config_in", "~/get_world_config"),
            # ("~/add_obstacle_in", "~/add_obstacle"),
            # ("~/set_obstacle_in", "~/set_obstacle"),
            # ("~/get_max_z_in", "~/get_max_z"),
            # ("~/get_use_in", "~/get_use"),
            # ("~/set_world_origin_out", "estimation_manager/set_origin"),
    ...
    # #} end of safety area manager node
